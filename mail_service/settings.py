...
SECRET_KEY = 'django-insecure-%%0$cggm&hxrk5rgrhyav1i$8egzsmv#_@qt-io$ehg3u#9=5l'
...
MIDDLEWARE = [
    ...
    'allauth.account.middleware.AccountMiddleware',  # Added manually else error occurs
]
